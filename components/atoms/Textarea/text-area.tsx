      ...
      <label className="flex flex-col w-full">
        ...
        <div
          className={clsx(
            ...
            value?.length > maxLength ? "focus-within:border-light-red-10" : "focus-within:border-light-orange-9 ",
            className
          )}
        >
          <textarea
        ...
        {value?.length > maxLength ? (
          <p aria-live="assertive" className="mt-2 text-light-red-10 text-xs">
            {warnMsg}
          </p>
        ) : (
